...
function buildAdPage(ad, relatedAds) {
    ...
    var city = esc((ad.ct || '').trim() || countryLabel);
    ...
    return '<!DOCTYPE html>\n<html lang="hr">\n<head>\n' +
        ...
        'function reveal(el){if(!el.classList.contains("blurred"))return;el.classList.remove("blurred");trackView();var v=el.getAttribute("data-v");if(el.classList.contains("wa-tag")){var n=v.replace(/[^0-9+]/g,"");el.innerHTML=\'<a href="https://wa.me/\'+n.replace("+","")+\'?text=\'+encodeURIComponent("Hej, vidio sam tvoj oglas na besplatnismsoglasi.com")+\'" target="_blank" rel="noopener" onclick="trackView()" style="color:#27ae60;text-decoration:none">WhatsApp: \'+v+\' &#8599;</a>\'}else if(el.classList.contains("vb-tag")){var n=v.replace(/[^0-9+]/g,"");el.innerHTML=\'<a href="viber://chat?number=\'+encodeURIComponent(n)+\'" target="_blank" rel="noopener" onclick="trackView()" style="color:#7b1fa2;text-decoration:none">Viber: \'+v+\' &#8599;</a>\'}else{el.innerHTML=\'<a href="mailto:\'+v+\'" onclick="trackView()" style="color:#2980b9;text-decoration:none">\'+v+\' &#9993;</a>\'}}\n' +
